...
class RepsOrTimerView: UIView {
    ...
    private let setsSlider: UISlider = {
        ...
        slider.addTarget(RepsOrTimerView.self, action: #selector(setsSliderChanged), for: .valueChanged)
        return slider
    }()
    ...
    private let repsSlider: UISlider = {
        ...
        slider.minimumTrackTintColor = .specialGreen
        slider.translatesAutoresizingMaskIntoConstraints = false
        slider.addTarget(RepsOrTimerView.self, action: #selector(repsSliderChanged), for: .valueChanged)
        return slider
    }()
    ...
    private let timerSlider: UISlider = {
        ...
        slider.minimumTrackTintColor = .specialGreen
        slider.translatesAutoresizingMaskIntoConstraints = false
        slider.addTarget(RepsOrTimerView.self, action: #selector(timerSliderChanged), for: .valueChanged)
        return slider
    }()
