...
class NewWorkoutViewController: UIViewController {
    ...
    private let closeButton: UIButton = {
        ...
        button.addTarget(NewWorkoutViewController.self, action: #selector(closeButtonTapped), for: .touchUpInside)
        return button
    }()
...
//    }()
    ...
    private let saveButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(NewWorkoutViewController.self, action: #selector(saveButtonTapped), for: .touchUpInside)
        return button
    }()
